 ...
 *
 * The nav icons that used to be lucide components (dashboard, document-library,
 * asset-library, presentation-hub, team/users, ibe-product-suite) are inlined
 * here as their real lucide-react@1.18.0 geometry so individual inner parts can
 * carry .ic-* classes for the per-part hover micro-animations (shell.css).
 */
...
export function NavIcon({ name }: { name: string }) {
  switch (name) {
    ...
    case "ibe-product-suite":
      // lucide gallery-vertical-end (2 sheet lines + a card) — sheets fan up.
      return (
        <I>
          <path className="ic-gal-1" d="M7 2h10" />
          <path className="ic-gal-2" d="M5 6h14" />
    ...
    case "internal-branding":
      return (
        <I>
          ...
          <polyline className="ic-doc-corner" points="14 2 14 8 20 8" />
        </I>
      );
    case "airtuerk-apix":
      return (
        <I>
          <polyline className="ic-apix-gt" points="16 18 22 12 16 6" />
          <polyline className="ic-apix-lt" points="8 6 2 12 8 18" />
        </I>
      );
    case "multicheck":
      return (
    ...
    case "mystats":
      return (
        <I>
          <line className="ic-stat-1" x1="12" y1="20" x2="12" y2="10" />
          <line className="ic-stat-2" x1="18" y1="20" x2="18" y2="4" />
          <line className="ic-stat-3" x1="6" y1="20" x2="6" y2="16" />
        </I>
      );
    case "asset-library":
      // lucide library-big (book block + spine + tilted book) — parts lift.
      return (
        <I>
          <rect className="ic-lib-1" width="8" height="18" x="3" y="3" rx="1" />
          <path className="ic-lib-2" d="M7 3v18" />
          <path className="ic-lib-3" d="M20.4 18.9c.2.5-.1 1.1-.6 1.3l-1.9.7c-.5.2-1.1-.1-1.3-.6L11.1 5.1c-.2-.5.1-1.1.6-1.3l1.9-.7c.5-.2 1.1.1 1.3.6Z" />
        </I>
      );
    case "document-library":
      // lucide files (front file + its corner, and the back file) — they fan apart.
      return (
        <I>
          <path className="ic-files-front" d="M15 2h-4a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8" />
          <path className="ic-files-front" d="M16.706 2.706A2.4 2.4 0 0 0 15 2v5a1 1 0 0 0 1 1h5a2.4 2.4 0 0 0-.706-1.706z" />
          <path className="ic-files-back" d="M5 7a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h8a2 2 0 0 0 1.732-1" />
        </I>
      );
    case "team":
    case "users":
      // lucide users (1.18.0 has a single head circle + body paths) — head bobs.
      return (
        <I>
          <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
          <path d="M16 3.128a4 4 0 0 1 0 7.744" />
          <path d="M22 21v-2a4 4 0 0 0-3-3.87" />
          <circle className="ic-user-head" cx="9" cy="7" r="4" />
        </I>
      );
    case "presentation-hub":
      // lucide presentation (top rail + screen body + easel base) — base lifts.
      return (
        <I>
          <path d="M2 3h20" />
          <path d="M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3" />
          <path className="ic-pres-base" d="m7 21 5-5 5 5" />
        </I>
      );
    default:
      return (
