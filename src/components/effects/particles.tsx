...
// Self-contained canvas particle field (HextaUI / MagicUI pattern, MIT). No
// external dependency — the only import is the project's cn() helper. Props
// match the call sites in the login pages: quantity, ease, color, size, refresh.
...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  // rgb recomputes only when the color prop changes (Phase E adjustment 3).
