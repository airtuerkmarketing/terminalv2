...
**Date:** 2026-06-26
**Status:** Built on branch `claude/busy-ishizaka-21ca9c`. Migration `20260626140000_self_service_profile_fields` **APPLIED to prod 2026-06-26** (additive — live site unaffected, old `getTeamMembers` query is column-compatible). **Pending go-live:** email-template swap + merge/deploy.
